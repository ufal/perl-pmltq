...
$PMLTQ::Relation::Treex::TEChildIterator::VERSION = '2.0.0'; # TRIAL
...
PMLTQ::Relation::Treex::TEChildIterator - Effective child relation iterator on t-nodes for Treex treebanks
